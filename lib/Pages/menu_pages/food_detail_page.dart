...
class FoodDetailPage extends StatefulWidget {
  ...
  FoodDetailPage(this.currentFood);
...
class _FoodDetailPageState extends State<FoodDetailPage> {
  ...
  void _sendMessage() {
    //format: changeFood::foodIndexToChange::name::description::price::discount::available::typeFood
    SocketConnect.socket.then((value) {
      print('Connect to server');
      value.writeln("changeFood::" +
          widget.currentFood.toString() +
          "::" +
