...
class _OrdersListPageState extends State<OrdersListPage> {
  ...
  void _sendMessage(int index) async {
    await SocketConnect.socket.then((value) async {
      ...
      String sendMessage = "setDelivered" +
          "::" +
          currentRestaurant.getOrders()[index].getId().toString() +
          "::" +
      ...
      child: Column(
        ...
        children: [
          RichText(
            text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(
                    text:
                        currentRestaurant.getOrders()[index].getCustomerName(),
          ...
          Padding(
            ...
            child: Container(
              child: Text(currentRestaurant.getOrders()[index].getOrderTime()),
            ),
          ),
        ],
      ),
  ...
  detail1(index) {
    double _width = 100;
    Iterable<Food> keys = currentRestaurant.getOrders()[index].getOrder().keys;
  ...
  price(index) {
    return Container(
      child: Column(
        children: [
          Text(
              currentRestaurant.getOrders()[index].getPrice().toString() + 'T'),
          SizedBox(
            height: 10,
          ),
          FlutterSwitch(
            ...
            onToggle: (value) {
              setState(() {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => BasePage(1)),
                );
              });
            },
          ),
        ...
        child: FlatButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => OrderDetailPage(currentRestaurant, index),
              ),
            );
          },
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      children: List.generate(
          currentRestaurant.getOrders().length, (index) => showOrder(index)),
    ));
  }
}
